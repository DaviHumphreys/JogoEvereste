camera_set_view_size(view_camera[0], global.larguraCamera, global.alturaCamera)

if instance_exists(view_target)
{
	var x1 = view_target.x - global.larguraCamera / 2;
	var y1 = view_target.y - global.alturaCamera / 2;
